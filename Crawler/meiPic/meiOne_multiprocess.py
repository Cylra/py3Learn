...
import urllib.error
import time
from multiprocessing import Pool #同时爬取多页
...
def download(onePage, folder):
    #os.chdir('/home/long/桌面/CC/py3Learn/Crawler/Deep in Python Web Crawler/meipic/pic')
...
for i in range(7, 26):
    ...
    #采用多进程处理不同页面
    p.apply_async(download, args = (page, folder))
